...
def load_training_data(sentiment):
    ...
    if sentiment == "anger":        
        threshold = 0.5
        data = open("data/anger_training_set.txt",encoding="utf8")
    elif sentiment == "fear":
        threshold = 0.6
        data = open("data/fear_training_set.txt",encoding="utf8")
    elif sentiment == "sadness":
        threshold = 0.5
        data = open("data/sadness_training_set.txt",encoding="utf8")
    elif sentiment == "joy":
        threshold = 0.5
        data = open("data/joy_training_set.txt",encoding="utf8")
    else:
        pass
