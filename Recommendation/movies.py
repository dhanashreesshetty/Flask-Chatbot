...
def fetch_movies(emotion):
    movies = []
    if(emotion == 'joy'):
        f1=open('Recommendation\movie_data/adventure.json', 'r')
        f2=open('Recommendation\movie_data/drama.json', 'r')
        f3=open('Recommendation\movie_data/romcom.json', 'r')
        f4=open('Recommendation\movie_data/fantasy.json', 'r')
        ...
        f1=open('Recommendation\movie_data/animation.json', 'r')
        f2=open('Recommendation\movie_data/fantasy.json', 'r')
        f3=open('Recommendation\movie_data/thriller.json', 'r')
        f4=open('Recommendation\movie_data/comedy.json', 'r')
        ...
        f1=open('Recommendation\movie_data/animation.json', 'r')
        f2=open('Recommendation\movie_data/comedy.json', 'r')
        f3=open('Recommendation\movie_data/comact.json', 'r')
        f4=open('Recommendation\movie_data/romcom.json', 'r')
        animation = json.load(f1)
        comedy = json.load(f2)
        comact = json.load(f3)
        romcom = json.load(f4)
